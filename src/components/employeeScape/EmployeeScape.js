    ...
    <div className="app-design-details-container">
      ...
      <div className="app-design-detail-container">
        ...
        <div className="app-design-details">
          ...
          <div className="">
            A potentional Intranet solution for mid to large organizations, who
            want to give their employees access to all the required resources
            and support in a seamless manner.
          </div>
        </div>
        <div className="app-design-details">
          ...
          <div className="">
            ...
            their overall company, their schedules, their training plans, their
            time off details and much more. EmployeeScape wants to assist
            employees complete their onboarding process easily and instantly
            feel acquainted to the their team too. Also, help them learn about
            their Benefits and perks and how they can utilise the same.
          </div>
        </div>
      ...
      <div className="app-design-detail-text">
        ...
        needs of the end users. In our case, we are focused on the needs of the
        employees working for mid to large size companies.
      </div>
      <img
        src={DesignThinking}
        alt="Design thinking"
      ...
      <div className="app-design-detail-text">
        ...
        or superiors or even peers, in understanding company goals, policies or
        benefits.
      </div>
      <div className="app-design-detail-text">
        According to research by Gallup,
        <br /> “88 % of organizations don’t do a great job at onboarding their
        employee resulting in poor employee engagement with the organization and
      ...
      <div className="app-design-detail-text">
        Most employees feel unprepared and confused right from day one and that
        carries along further. Such sentiments of confusion and not knowing
        one’s whereabouts clearly leads to affect work and productivity.
      </div>
      <div className="app-design-detail-text">
        As per research, employee engagement is the key to building a successful
        business. But driving employee engagement doesn't come easy - only 15%
        of employees are engaged with their companies. And employee engagement
        is directly proportional to the employee retention factor.
      </div>
      <div className="app-design-detail-text">
      ...
      <div className="app-design-detail-text center">
        <div>
          <div className="app-design-detail-text">
            ...
            years if they experienced great onboarding and felt an overall sense
            of belonging at their workplace. (source).
          </div>
      ...
      <div className="app-design-detail-text">
        ...
        secondary research, I was fouced on asking myself a question that would
        guide me towards finding a effective and proactive solution.
      </div>
      <div className="app-design-detail-text">
        I have personally faced this problem in the past while working with
        large organizations and instantly connect to the problem as an end user
        - a company employee.
      </div>
